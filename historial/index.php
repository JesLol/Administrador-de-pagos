...
<head>
    ...
    <script src="../main/js/nav-res.js"></script>
    <script src="../main/js/nav-btn.js"></script>
...
<body>
    ...
    <main class="historial-main">
        ...
        <section class="mi-historial-section">
            <article class="mi-historial-article">
                <h2>Mi historial</h2>
                <div id="historial-div-container" class="historial-div-container"></div>
            </article>
        </section>
    </main>
